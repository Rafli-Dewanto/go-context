...
func TestContextWithValue(t *testing.T) {
	...
	fmt.Println("contextF.Value(f)", contextF.Value("f"))
	fmt.Println("contextF.Value(c)", contextF.Value("c"))
	fmt.Println("contextF.Value(b)", contextF.Value("b"))

	fmt.Println("contextA.Value(b)", contextA.Value("b"))
}
